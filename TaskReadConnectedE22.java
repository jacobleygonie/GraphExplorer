...
public class TaskReadConnectedE22 extends Thread {
	...
	TaskReadConnectedE22(LockfreeQueue<CoupleResult> ALire,HashMap<String,Couple> rempli,LockfreeQueue<Trio> UrlEtPage, AtomicInteger N,int NombreGeneration,int GenerationCourante){
		this.ALire=ALire;
		this.rempli=rempli;
