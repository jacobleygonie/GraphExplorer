...
public class TaskVerification extends Thread{
	String  _url;
	HashMap<String,Boolean> rempli; //boolean true si c'est un personnage
	
	public TaskVerification(String url,HashMap<String,Boolean> rempli)
	 {
		this._url = url;
		this.rempli = rempli;
	}
	...
	public  void run() {
		// TODO Auto-generated method stub
			...
			if (page.indexOf("Biographical information", 40000)>=0) {
